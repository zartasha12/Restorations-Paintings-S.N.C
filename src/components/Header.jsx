...
const Header = () => {
  ...
  return (
    <>
      <HeaderLinks />
      <header className=" xl:px-10 shadow-xl h-[100px] ">
        <nav key="1" className="px-2 sm:px-4">
          <div className="flex justify-between items-center mx-auto">
            <div className="z-50  md:w-auto w-full flex justify-between">
              <Link to="" className="flex items-center">
                <img src={logo} className="w-[124px] h-[92px]" alt="Logo" />
              </Link>
            </div>
            <div className="flex items-center lg:order-2" ref={dropdownRef}>
              <div className="relative">
                <button
                  onClick={() => setIsDropdownOpen(!isDropdownOpen)}
                  className="inline-flex items-center justify-center h-10 text-white bg-red-700 hover:bg-red-800 font-medium rounded-lg text-sm px-4 py-2.5 text-center mr-3 md:mr-0 dark:bg-red-600 dark:hover:bg-red-700 
                "
                >
                  {t("LANGUAGE")}{" "}
                  <svg
              ...
              >
                ...
                {open && (
                  <div
                    className={`
             bg-gray-200 fixed top-20 right-0 mx-4 my-2 sidebar 
                `}
                  >
                    <div className="py-2">
                      <Link
