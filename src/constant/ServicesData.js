...
export const ServicesData = [
  {
    ...
    img: BuildingRestoration,
   
    description: "With the help of our extensive restoration services, you can bring back the integrity and beauty of old and historic buildings. Our approach involves revitalising buildings while respecting their distinct history and character, which includes fixing facade damage and maintaining architectural elements."
  },
  {
    id: 2,
    title: "Exterior Painting and Finishing",
    img: ExteriorPainting,
    
    description: "Our skilled exterior painting treatments will protect your house and increase its curb appeal. We guarantee durable finishes that refuse weather and leave a lasting impact by using premium paints and tried-and-true methods",
...
export const testimonialimg = [
  ...
  },
  {
    ...
    text: "Their attention to detail and commitment to quality were evident throughout the entire process. They seamlessly blended their artistic expertise with construction know-how, resulting in a space that is both functional and aesthetically pleasing",
  },
];
